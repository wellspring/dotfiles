...
complete -c last -s i -l ip --description 'Like  --dns but displays the host\'s IP number instead of name.'
...
complete -c last -s s -l since --description 'Display the state of logins since specified R time .'
...
complete -c last -s n -l limit --description 'This is a count telling last how many lines to show.'
