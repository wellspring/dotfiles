...
complete -c p11tool -l list-all-privkeys --description 'List all available private keys in a token.'
complete -c p11tool -l list-privkeys --description 'This is an alias for the --list-all-privkeys option.'
complete -c p11tool -l list-keys --description 'This is an alias for the --list-all-privkeys option.'
...
complete -c p11tool -l login -l no-login --description 'Force (user) login to token.'
complete -c p11tool -l so-login -l no-so-login --description 'Force security officer login to token.'
complete -c p11tool -l admin-login --description 'This is an alias for the --so-login option.'
