...
complete -c numactl -l all -s a --description 'Unset default cpuset awareness, so user can use… [See Man Page]'
...
complete -c numactl -l preferred --description 'Preferably allocate memory on  node, but if mem… [See Man Page]'
...
complete -c numactl -l file --description 'to specify the shared memory segment or file an… [See Man Page]'
...
complete -c numactl -l strict --description 'Give an error when a page in the policied area … [See Man Page]'
complete -c numactl -l shmmode --description 'Only valid before --shmid or --shm When creatin… [See Man Page]'
complete -c numactl -l length --description 'Apply policy to  length  range in the shared me… [See Man Page]'
...
complete -c numactl -l cpubind --description 'which accepts node numbers, not cpu numbers, is… [See Man Page]'
