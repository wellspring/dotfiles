...
(define (script-fu-blood-logo inText inFont inFontSize inBorder inDrip)
    ...
    (define textLayer (car(gimp-layer-new theImage 10 10 RGBA-IMAGE "text layer" 100 NORMAL-MODE)) )
    (define bloodLayer (car(gimp-layer-new theImage 10 10 RGBA-IMAGE "blood layer" 100 NORMAL-MODE)) )
    (define backLayer(car(gimp-layer-new theImage 10 10 RGBA-IMAGE "Background" 100 NORMAL-MODE)) )
