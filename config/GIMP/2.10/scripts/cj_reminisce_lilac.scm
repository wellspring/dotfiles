...
; Description: Produces a stylized violet color effect on images.
;
; © 2008 Claire Jones
;
...
(define (script-fu-reminisce-lilac    	image
										layer
	)
...
(let*	(
    ...
    (gimp-layer-set-opacity purple-soft 60))
...
(script-fu-register 
	"script-fu-reminisce-lilac"
	"Reminisce Lilac"
	"Produces a stylized violet color effect on images."
	"Claire Jones"
	"© 2008 Claire Jones"
	"September 22, 2008"
	"RGB*"
    ...
    (script-fu-menu-register "script-fu-reminisce-lilac" "<Image>/Filters/Colors/Reminisce")		
