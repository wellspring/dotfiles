...
(define (script-fu-dawn-yellow    	image
									layer
	)
...
(let*	(
    ...
    (gimp-layer-set-opacity yellow-merge 20))	
...
(script-fu-menu-register "script-fu-dawn-yellow" "<Image>/Filters/Colors/Dawn")		
