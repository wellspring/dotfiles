...
(define (fp-halftone-pixel image layer useVisible dither mode opacity invertHalftone mask invertMask)
  (let* (
   	(isMask nil)
	(newImage nil)
	(width nil)
...
(script-fu-register "fp-halftone-pixel"
         "Halftone Pixel..."
...
SF-OPTION "Blend Mode" '( "Softlight Mode"     ; 19
                                   "Normal"  ; 0
         "Dissolve"   ; 1
                                   "Multiply"   ; 3
                                   "Divide"     ; 15
...
(script-fu-menu-register "fp-halftone-pixel"
  "<Image>/Filters/Decor"
  )