;=======================================================================
; Reminisce Overcast v.1
; Author: Claire Jones
; Website: http://clairejones.deviantart.com
; Description: Produces a stylized dark yellow color effect on images.
;
; © 2008 Claire Jones
;
...
(define (script-fu-reminisce-overcast    	image
											layer
	)
...
(let*	(
    ...
    (gimp-layer-set-opacity beige-soft 25))
...
(let*	(
    ...
    (gimp-layer-set-opacity orange-burn 25))
...
(let*	(
    ...
    (gimp-image-add-layer image yellow-merge 0)
   	...
   	(gimp-layer-set-opacity yellow-merge 25))	
...
(script-fu-register 
	"script-fu-reminisce-overcast"
	"Reminisce Overcast"
	"Produces a stylized dark yellow color effect on images."
	"Claire Jones"
	"© 2008 Claire Jones"
	"September 23, 2008"
	"RGB*"
    ...
    (script-fu-menu-register "script-fu-reminisce-overcast" "<Image>/Filters/Colors/Reminisce")		
