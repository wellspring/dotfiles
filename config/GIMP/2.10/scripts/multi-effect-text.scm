; Multi-Text Effect V1.0 (11-2007) (c) Copyright
...
; You can control various aspects of each effect by adjusting the effect tweak parameter and the scatter parameter.
; 
...
;
; *NOTE: Scatter-HSV is handled differently 2.4 that it was in Gimp 2.2. When using Gimp 2.2, set scatter lower (40-60)
