...
; Description: Lightens and mutes colours while applying a violet filter to 
...
(define (script-fu-dawn-violet    	image
									layer
	)
...
(let*	(
    ...
    (gimp-layer-set-opacity beige-soft 80))		
...
(script-fu-register 
	"script-fu-dawn-violet"
	"Dawn Violet"
	"Lightens and mutes colours while applying a violet filter to dark photos and images."
	"Claire Jones"
	"© 2008 Claire Jones"
	"September 30, 2008"
	"RGB*"
...
(script-fu-menu-register "script-fu-dawn-violet" "<Image>/Filters/Colors/Dawn")		
