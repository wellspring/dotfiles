...
; Description: Lightens, mutes colours and applies an orange filter to dark 
;                   photos and images.
;
; © 2008 Claire Jones
;
...
(define (script-fu-dawn-orange    	image
									layer
	)
...
(let*	(
    ...
    (gimp-layer-set-opacity orange-soft 20))		
...
(script-fu-register 
	"script-fu-dawn-orange"
	"Dawn Orange"
	"Lightens, mutes colours and applies an orange filter to dark photos and images."
	"Claire Jones"
	"© 2008 Claire Jones"
	"September 30, 2008"
	"RGB*"
...
(script-fu-menu-register "script-fu-dawn-orange" "<Image>//Filters/Colors/Dawn")		
