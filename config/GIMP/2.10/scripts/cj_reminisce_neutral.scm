;=======================================================================
; Reminisce Neutral v.1
; Author: Claire Jones
; Website: http://clairejones.deviantart.com
; Description: Produces a stylized beige color effect on images.
;
; © 2008 Claire Jones
;
...
(define (script-fu-reminisce-neutral    	image
											layer
	)
...
(let*	(
	(orange-multiply (car (gimp-layer-new-from-drawable layer image)))
	)

	(gimp-layer-set-name orange-multiply "Orange Multiply")
	(gimp-context-set-foreground '(229 133 83))
	(gimp-drawable-fill orange-multiply FOREGROUND-FILL) 
    (gimp-image-add-layer image orange-multiply 0)
   	(gimp-layer-set-mode orange-multiply 3)
   	(gimp-layer-set-opacity orange-multiply 25))
...
(script-fu-register 
	"script-fu-reminisce-neutral"
	"Reminisce Neutral"
	"Produces a stylized beige color effect on images."
	"Claire Jones"
	"© 2008 Claire Jones"
	"September 22, 2008"
	"RGB*"
    ...
    (script-fu-menu-register "script-fu-reminisce-neutral" "<Image>/Filters/Colors/Reminisce")		
