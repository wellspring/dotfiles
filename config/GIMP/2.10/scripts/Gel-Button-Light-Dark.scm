...
(define (script-fu-sv-gel-buttonld mywidth myheight bgcolor)
...
(script-fu-register "script-fu-sv-gel-buttonld"
		    _"<Toolbox>/Filters/Alpha to Logo/GelBar-Light-Dark"
