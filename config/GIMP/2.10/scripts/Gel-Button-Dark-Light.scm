...
(define (script-fu-sv-gel-buttondl mywidth myheight bgcolor)
...
(script-fu-register "script-fu-sv-gel-buttondl"
		    _"<Toolbox>/Filters/Alpha to Logo/GelBar-Dark-Light"
